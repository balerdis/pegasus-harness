...
PRODUCT_IDENTITY_ALLOWLIST = frozenset(
    {
        ...
        "PEGASUS_SKILL_ROOTS",
        # Everything below this line is NOT a wire identifier -- it is a
        # brand baked into an on-disk artifact name that a distribution's own
        # rename would have to reach too, and hasn't yet. Renaming these is
        # deferred work this allowlist is honestly admitting, not a design
        # decision that they should stay `pegasus`-branded forever.
        "pegasus-AGENTS.md",
        "pegasus/skill-registry",
        "pegasus-skill-registry.env",
        "pegasus-skill-registry",
        "<!-- Generated by Pegasus skill registry. Regenerate with pegasus-skill-registry. -->",
        "Generate a Pegasus skill registry",
    }
)
