...
Usá el tag que quieras instalar. El ejemplo usa `v4.1.1`, que es el último publicado.
...
curl -fL -O "$BASE_URL/pegasus_harness-4.1.1-py3-none-any.whl"
curl -fL -O "$BASE_URL/pegasus_harness-4.1.1-py3-none-any.whl.sha256"
...
sha256sum -c pegasus_harness-4.1.1-py3-none-any.whl.sha256
...
"$DATA_DIR/venv/bin/python" -m pip install --no-deps pegasus_harness-4.1.1-py3-none-any.whl
```
...
`Successfully installed pegasus-harness-4.1.1`.*
