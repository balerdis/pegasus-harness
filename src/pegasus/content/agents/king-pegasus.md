...
- Resolve Strict TDD Mode once per session with `{{skills_root}}/_shared/implementation-craft.md` before writing code; if it is missing or unreadable, judge it yourself and say so.
