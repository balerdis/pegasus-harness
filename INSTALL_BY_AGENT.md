...
WHEEL="pegasus_harness-4.1.0-py3-none-any.whl"
...
pegasus-harness-4.1.0` (publicado). El `pip install --require-hashes -r requirements.txt` no se pudo completar sin red — se
