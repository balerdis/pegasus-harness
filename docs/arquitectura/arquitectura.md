...
| (b) Record FTD y persistencia | `ftd-procedure.md`, `docs/ftd/`, el aviso único, el enlace con Engram, *Decisions*, *Next* con tres estados, la graduación de decisiones y las reglas de evidencia | En curso. b1–b5 hecho: `ftd-procedure.md` (880 palabras) con el record, *Next* en tres estados, la graduación, Engram, las nueve reglas de evidencia y la de secretos; el único puntero desde la salida FTD de la escalera (1058 de 1061); catálogo en (99, 27); suite 2986 |
