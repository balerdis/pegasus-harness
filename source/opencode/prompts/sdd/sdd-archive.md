...
Before task reconciliation, spec sync, or archive move, require completed persisted tasks, completed apply-progress, a current passing fresh-context `sdd-verify` report, and no unresolved implementation or test blocker. Native review transactions, receipts, ledgers, gate contexts, and review gates are not part of this local lifecycle.
...
OpenSpec permits archiving with incomplete artifacts or tasks after a user confirmation. Pegasus baseline is stricter by default:
